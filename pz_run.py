...
agent1 = load_fabric_checkpoint("cp_10.ckpt", mode="online")
# agent2 = load_agent("checkpoints/sup335/step=50000.ckpt", mode="online")

agent_names = ["selfplay", "shaping+pop"]
...
for g in range(n_games):
    ...
    for agent in agents.values():
        agent.reset()
    env = PettingZooGenerals(agents=agent_names, grid_factory=gf, render_mode=None)

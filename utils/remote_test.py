...
from checkpoints.sup106.neuro_agent import NeuroAgent
from checkpoints.sup106.network import Network
...
def main(args):
    network = torch.load("checkpoints/sup106/epoch=0-step=78000.ckpt", map_location="cpu")
